...
<!--
	...
	<section class="section2">
		...
		<div class="box_student_login">
			...
			<p style="padding-left: 15px;">
				...
				<br><br>
				New this websites &nbsp &nbsp<a href="registration.php">sign up</a>
			</p>
	...
	<?php
		...
		{
			$count=0;	
			$rel=mysqli_query($db,"SELECT * FROM `student` where username='$_POST[username]' && password= '$_POST[password]';");
