...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
 	...
 	<div class="srch">
      ...
      <button style="background-color:red; " class="btn btn-default" type="submit" name="submit1">
        Delete
 ...
 <div class="srch">
    ...
    <form class="navbar-form" method="post" name="form1">
      ...
      <button style="background-color:red; " class="btn btn-default" type="submit" name="submit2">
      Request
